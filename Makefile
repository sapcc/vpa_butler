...
install: FORCE build/vpa_butler
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/vpa_butler "$(DESTDIR)$(PREFIX)/bin/vpa_butler"
...
generate: install-controller-gen
	...
	@controller-gen crd rbac:roleName=vpa_butler webhook paths="./..." output:crd:artifacts:config=crd output:rbac:artifacts:config=config/rbac
...
help: FORCE
	...
	@printf "  \e[36mbuild/vpa_butler\e[0m             Build vpa_butler.\n"
